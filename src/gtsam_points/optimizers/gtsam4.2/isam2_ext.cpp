...
#include <gtsam_points/optimizers/gtsam4.2/isam2_ext_impl.hpp>
...
void ISAM2Ext::marginalizeLeaves(
  const FastList<Key>& leafKeysList, FactorIndices* marginalFactorsIndices, FactorIndices* deletedFactorsIndices) {
