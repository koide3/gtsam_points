...
template class gtsam_points::IntegratedColorConsistencyFactor_<gtsam_points::IntensityGradientsiVox, gtsam_points::PointCloud, gtsam_points::IntensityGradientsiVox>;
