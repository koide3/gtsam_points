...
int main(int argc, char** argv) {
  ...
  auto icp_factor = gtsam::make_shared<gtsam_ext::IntegratedICPFactor>(0, 1, base_frame, base_frame2);

  // If you are interested in using your custom classes with gtsam_ext, see "advanced_frame_manipulation.cpp".
