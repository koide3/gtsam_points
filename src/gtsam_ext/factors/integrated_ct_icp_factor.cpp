...
template class gtsam_ext::IntegratedCT_ICPFactor_<gtsam_ext::iVox, gtsam_ext::Frame>;
template class gtsam_ext::IntegratedCT_ICPFactor_<gtsam_ext::iVoxCovarianceEstimation, gtsam_ext::Frame>;
