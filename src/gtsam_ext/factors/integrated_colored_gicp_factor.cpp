...
template class gtsam_ext::IntegratedColoredGICPFactor_<gtsam_ext::iVox, gtsam_ext::PointCloud, gtsam_ext::IntensityGradients>;
template class gtsam_ext::IntegratedColoredGICPFactor_<gtsam_ext::PointCloud, gtsam_ext::PointCloud, gtsam_ext::IntensityGradients>;
template class gtsam_ext::IntegratedColoredGICPFactor_<gtsam_ext::IntensityGradientsiVox, gtsam_ext::PointCloud, gtsam_ext::IntensityGradientsiVox>;
