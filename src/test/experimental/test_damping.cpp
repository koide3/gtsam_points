...
int main(int argc, char** argv) {
  ...
  graph.emplace_shared<gtsam_ext::LoosePriorFactor<gtsam::Pose3>>(0, gtsam::Pose3(), gtsam::noiseModel::Isotropic::Precision(6, 10.0));
  ...
  gtsam_ext::LevenbergMarquardtOptimizerExt(graph, values, lm_params).optimize();
  ...
  graph.at(1) = gtsam::make_shared<gtsam_ext::LinearDampingFactor>(0, 6, 10.0);
